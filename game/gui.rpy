...
define gui.text_font = "assets/monaco.ttf"

## The font used for character names.
define gui.name_text_font = "assets/monaco.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "assets/monaco.ttf"
...
# define gui.main_menu_background = "assets/bg_1.png"

image main_menu_background:
    "assets/bg_1.png" with Dissolve(0.5, alpha=True)
    pause .5
    "assets/bg_2.png" with Dissolve(0.5, aplha=True)
    pause .5
    repeat #required to cycle over and over again!
